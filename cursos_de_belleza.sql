...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-09-2024 a las 22:11:28
...
--
-- Base de datos: `cursos_de_belleza`
--
...
CREATE TABLE `alumnos` (
  ...
  `dni` int(11) NOT NULL,
  `numero_de_celular` bigint(20) NOT NULL,
...
INSERT INTO `alumnos` (`ID_alumno`, `nombre`, `apellido`, `dni`, `numero_de_celular`, `domicilio`) VALUES
...
CREATE TABLE `cursos` (
  ...
  `profesor/a` varchar(45) NOT NULL,
...
INSERT INTO `cursos` (`ID_curso`, `nombre`, `descripcion`, `duracion`, `profesor/a`, `costo`) VALUES
...
ALTER TABLE `alumnos`
  ...
  ADD UNIQUE KEY `numero_de_celular` (`numero_de_celular`);
